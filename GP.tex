...
%TODO: 1.7	A list of contributions with short descriptions that you can claim from your work.
...
%what devices are used in the network, how they are used, and how they are connected
...
\begin{figure}
    ...
    \label{fig:tspolicy}
\end{figure}
%TODO: Pictures for the rest of the features
%TOOO: Rogue DHCP server detection دييي اتش سي بي
%TODO: Proper casing for brand names
...
%4.2	What infrastructure your solution depends on, or is using to accomplish its tasks? 
...
%Table with device, cost, small description of each device main selling points and quantity needed
\begin{table}[h]
    \centering
...
%TODO: QoS for staff, profs, students (eng and others) and guests + guest nw

\chapter{Conclusion and Future Work}
\section{Summary}
%8.1	Summarize the main contributions of the work.
